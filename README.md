...
- Yellow highlights; active match in orange and scrolled into view whenever it changes, including as you type (Chrome's find-as-you-type)
...
| `hooks/` | `useFindBarVisibility`, `useMatchNavigation` |
...
5. Change the query — the counter resets to the first match of the new term and scrolls there. An empty result shows `0/0` in red.
